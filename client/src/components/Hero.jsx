      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-4">
            <button onClick={() => { logEvent('CTA', 'Schedule Free Call Clicked', 'Schedule Free Call'); setShowScheduler(true); }} className="bg-[#426369] text-white px-8 py-4 rounded-xl font-bold hover:bg-[#354f54] transition-all flex items-center gap-2 shadow-xl shadow-teal-900/20 cursor-pointer">
              Schedule Free Call <ChevronRight  className="w-5 h-5" />
            </button>
            <button onClick={() => { logEvent('CTA', 'View Our Work Clicked', 'View Our Work'); navigate('/portfolio'); }} className="border-2 border-gray-200 text-gray-700 px-8 py-4 rounded-xl font-bold hover:border-[#426369] hover:text-[#426369] transition-all flex items-center gap-2 cursor-pointer">
