  ...
  <section className="py-12 px-6">
    <div className="max-w-7xl mx-auto bg-[#426369] rounded-[2.5rem] p-12 lg:p-20 lg:py-14 relative overflow-hidden text-center shadow-2xl shadow-teal-900/30">
      ...
      <div className="relative z-10 max-w-2xl mx-auto space-y-8">
        ...
        <button className="bg-white text-[#426369] px-10 py-5 rounded-2xl font-bold hover:bg-teal-50 transition-all text-lg shadow-xl shadow-black/10 cursor-pointer">
          Schedule Free Call
        </button>
      </div>
    </div>
